...
public class SharePreferenceUtils {
    ...
    private final static String KEY_PUSH_EVENT_REVENUE_1_DAY = "KEY_PUSH_EVENT_REVENUE_1_DAY";
    ...
    public static void updateCurrentTotalRevenueAdApplovin(Context context, float revenue) {
        SharedPreferences pre = context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
        float currentTotalRevenue = pre.getFloat(KEY_CURRENT_TOTAL_REVENUE_AD, 0);
    ...
    public static boolean isPushRevenue1Day(Context context) {
        SharedPreferences pre = context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
    ...
    public static void setPushedRevenue1Day(Context context) {
        SharedPreferences pre = context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
        pre.edit().putBoolean(KEY_PUSH_EVENT_REVENUE_1_DAY, true).apply();
    }
