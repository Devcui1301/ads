...
*/
    ...
    public static void logPurchaseTotalRev(Context context, Bundle bundle) {
        FirebaseAnalytics.getInstance(context).logEvent("event_purchase", bundle);
    }

    public static void logMaxErrorCode(Context context, Bundle bundle) {
        FirebaseAnalytics.getInstance(context).logEvent("max_error_ads", bundle);
    }
