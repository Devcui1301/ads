...
//    private final Map<String, AppOpenAd> appOpenAdMap = new HashMap<>();
     ...
     * @param callback
     */
    public void forceShowInterstitial(Context context, MaxInterstitialAd interstitialAd, final AdCallback callback, boolean shouldReload, @Nullable String placementName) {
        currentClicked = numShowAds;
        showInterstitialAdByTimes(context, interstitialAd, callback, shouldReload, placementName);
    }
     ...
     */
    public void showInterstitialAdByTimes(final Context context, MaxInterstitialAd interstitialAd, final AdCallback callback, final boolean shouldReloadAds, @Nullable String placementName) {
        ...
        if (AppLovinHelper.getNumClickAdsPerDay(context, interstitialAd.getAdUnitId()) < maxClickAds) {
            showInterstitialAd(context, interstitialAd, callback, placementName);
            return;
        }
        if (callback != null) {
            callback.onAdClosed();
     ...
     * @param callback
     */
    private void showInterstitialAd(Context context, MaxInterstitialAd interstitialAd, AdCallback callback, String placementName) {
        currentClicked++;
...
//                new Handler().postDelayed(interstitialAd::showAd, 800);
     ...
     * @param id
     */
    public void loadBanner(final Activity mActivity, String id, @Nullable String placementName) {
        final FrameLayout adContainer = mActivity.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = mActivity.findViewById(R.id.shimmer_container_banner);
        loadBanner(mActivity, id, adContainer, containerShimmer, placementName);
    }
     ...
     * @param rootView
     */
    public void loadBannerFragment(final Activity mActivity, String id, final View rootView, @Nullable String placementName) {
    ...
    private void loadBanner(final Activity mActivity, String id, final FrameLayout adContainer, final ShimmerFrameLayout containerShimmer, @Nullable String placementName) {
        ...
        try {
            if (placementName != null) {
                adView.setPlacement(placementName);
            }
        } catch (Exception e) {
    ...
    public void loadNativeAd(Activity activity, String id, int layoutCustomNative, AppLovinCallback callback, @Nullable String placementName) {
        ...
        try {
            if (placementName != null) {
                nativeAdLoader.setPlacement(placementName);
            }
        } catch (Exception e) {
